...
- 每组参与 strict pair 的 execution class 数：[6, 6, 6, 5, 6, 6, 5, 6]；noise-aware best set 平均包含 3.125 个 execution class。
- noise-aware best semantic-plan set 随 group 变化，但所有 group 共同保留 5 个 possible plans，唯一 strict semantic winner 数为 0。
- global best fixed：rmsnorm.decompose_square_mul+rmsnorm.reassociate_scale (`sem_584eba078e62c9da`)；possible-win share 100.000%，raw P50/P90/max regret 为 0.000%/0.833%/1.299%，noise-aware max 为 0.000%。
- production/default 到 point oracle 的 median/P90/max gain 为 1.408%/2.187%/2.652%；到 noise-aware oracle 为 0.000%/0.000%/0.000%。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `phase2_rmsnorm_norm_only_decode_bs1_t1_bf16` | rms_d01,rms_d01_r02 | 8/8/8/8/6 | 8/1/6 | 3 | 6.890% | 2.652% | 0.000% | yes |
| `phase2_rmsnorm_norm_only_decode_bs8_t1_bf16` | rms_d02,rms_d02_r02 | 8/8/8/8/6 | 8/3/4 | 3 | 6.593% | 1.124% | 0.000% | yes |
| `phase2_rmsnorm_norm_only_prefill_bs1_s1024_bf16` | rms_p02,rms_p02_r02 | 8/8/8/8/6 | 7/0/8 | 3 | 6.962% | 1.899% | 0.000% | yes |
| `phase2_rmsnorm_norm_only_prefill_bs1_s128_bf16` | rms_p01 | 8/8/8/8/6 | 5/0/10 | 3 | 6.962% | 1.266% | 0.000% | yes |
| `phase2_rmsnorm_residual_silu_decode_bs1_t1_bf16` | rms_d03,rms_d03_r02 | 8/8/8/8/6 | 8/2/5 | 3 | 5.633% | 1.988% | 0.000% | yes |
| `phase2_rmsnorm_residual_silu_decode_bs8_t1_bf16` | rms_d04,rms_d04_r02 | 8/8/8/8/6 | 9/3/3 | 3 | 6.445% | 1.509% | 0.000% | yes |
| `phase2_rmsnorm_residual_silu_prefill_bs1_s1024_bf16` | rms_p04 | 8/8/8/8/6 | 6/1/8 | 4 | 6.494% | 1.299% | 0.000% | yes |
| `phase2_rmsnorm_residual_silu_prefill_bs1_s128_bf16` | rms_p03,rms_p03_r02 | 8/8/8/8/6 | 8/1/6 | 3 | 5.556% | 1.307% | 0.000% | yes |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `sem_584eba078e62c9da` | rmsnorm.decompose_square_mul+rmsnorm.reassociate_scale | 0.000% | 100.000% | 19.583% | 0.000% | 0.833% | 1.299% | 0.000% |
| `sem_f9305041e4a24aea` | rmsnorm.decompose_square_mul | 0.000% | 100.000% | 19.583% | 0.000% | 0.833% | 1.299% | 0.000% |
| `sem_1f8ff2cd110a45ba` | rmsnorm.decompose_square_pow | 0.000% | 100.000% | 19.583% | 0.026% | 0.332% | 0.572% | 0.000% |
| `sem_286a68462afba0aa` | rmsnorm.decompose_square_pow+rmsnorm.reassociate_scale | 0.000% | 100.000% | 19.583% | 0.026% | 0.332% | 0.572% | 0.000% |
| `sem_e8052199546100d5` | production_default | 0.000% | 100.000% | 19.583% | 1.408% | 2.187% | 2.652% | 0.000% |
| `sem_6217483aedc0e5e0` | rmsnorm.decompose_square_pow+rmsnorm.flatten_hidden_rows | 0.000% | 12.500% | 2.083% | 4.626% | 5.599% | 6.110% | 6.110% |
| `sem_9d4de2b6c6ee960c` | rmsnorm.decompose_square_mul+rmsnorm.flatten_hidden_rows | 0.000% | 0.000% | 0.000% | 5.405% | 6.332% | 6.962% | 6.962% |
| `sem_5bb3ef804d6e34e0` | rmsnorm.flatten_hidden_rows | 0.000% | 0.000% | 0.000% | 6.469% | 6.912% | 6.962% | 6.962% |

## Fixed Baselines

| scope | best fixed | raw P50 | raw P90 | raw max | noise max | possible win |
| --- | --- | --- | --- | --- | --- | --- |
| all | rmsnorm.decompose_square_mul+rmsnorm.reassociate_scale (`sem_584eba078e62c9da`) | 0.000% | 0.833% | 1.299% | 0.000% | 100.000% |
| decode | rmsnorm.decompose_square_mul+rmsnorm.reassociate_scale (`sem_584eba078e62c9da`) | 0.000% | 0.000% | 0.000% | 0.000% | 100.000% |
...
| --- | --- | --- | --- | --- | --- |
| 1 | rmsnorm.decompose_square_mul+rmsnorm.reassociate_scale (`sem_584eba078e62c9da`) | 0.000% | 0.833% | 1.299% | 0.000% |
...
| --- | --- | --- | --- | --- | --- |
| global_fixed | 1 | 0.000% | 0.833% | 1.299% | 0.000% |
| decode_vs_prefill | 2 | 0.000% | 0.000% | 0.000% | 0.000% |
| context_type | 2 | 0.000% | 0.833% | 1.299% | 0.000% |
| exact_shape_bucket | 4 | 0.000% | 0.000% | 0.000% | 0.000% |
| batch_threshold<=1 | 2 | 0.000% | 0.332% | 0.572% | 0.000% |
| sequence_length_threshold<=1 | 2 | 0.000% | 0.000% | 0.000% | 0.000% |
| token_threshold<=128 | 2 | 0.000% | 0.000% | 0.000% | 0.000% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `phase2_rmsnorm_norm_only_decode_bs1_t1_bf16` | 2 | 100.000% | 100.000% | 93.333% | 2.648% [2.375%, 2.922%] | 3.505% | yes | yes | 0.000% |
| `phase2_rmsnorm_norm_only_decode_bs8_t1_bf16` | 2 | 50.000% | 50.000% | 93.333% | 1.280% [1.231%, 1.328%] | 2.476% | yes | yes | 0.000% |
| `phase2_rmsnorm_norm_only_prefill_bs1_s1024_bf16` | 2 | 50.000% | 100.000% | 73.333% | 1.974% [0.000%, 3.947%] | 8.125% | yes | yes | 0.000% |
| `phase2_rmsnorm_residual_silu_decode_bs1_t1_bf16` | 2 | 100.000% | 100.000% | 93.333% | 1.985% [1.759%, 2.211%] | 4.043% | yes | yes | 0.000% |
| `phase2_rmsnorm_residual_silu_decode_bs8_t1_bf16` | 2 | 50.000% | 100.000% | 93.333% | 1.717% [1.641%, 1.793%] | 1.550% | yes | yes | 0.000% |
| `phase2_rmsnorm_residual_silu_prefill_bs1_s128_bf16` | 2 | 100.000% | 50.000% | 93.333% | 1.307% [1.299%, 1.316%] | 1.875% | yes | yes | 0.000% |
